...
@pytest.mark.asyncio
async def test_list_books_filter_by_author(client: AsyncClient, test_author, test_book):
...
@pytest.mark.asyncio
async def test_create_book_as_user_forbidden(
    client: AsyncClient, user_token, test_author
):
    response = await client.post(
        "/books",
        json={
...
@pytest.mark.asyncio
async def test_create_book_negative_price(
    client: AsyncClient, admin_token, test_author
):
    response = await client.post(
        "/books",
        json={
